...
public final class MD5Util {
	...
	public static final String MD5_16bit(String readyEncryptStr) throws NoSuchAlgorithmException{
		if(readyEncryptStr != null){
			return MD5Util.MD5_32bit(readyEncryptStr).substring(8, 24);
		}else{
			return null;
		}
	}
	...
	public static void main(String[] args) {
		try {
			String md516 = MD5Util.MD5_16bit("kaka123");
			System.out.println("16bit-md5:\n" + md516); //
			String md532 = MD5Util.MD5_32bit("kaka123");
			String md5321 = MD5Util.MD5_32bit1("kaka123");
			String md5322 = MD5Util.MD5_32bit2("kaka123");
